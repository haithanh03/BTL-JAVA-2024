...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("@NHOM12-By:ThanhLuan+HaiThanh+VietAnh+HoaUyen+ThanhHuu");
...
//đoạn code trên chỉ để chọn quyền đăng nhập
       if(username.equals("")||password.equals("")){
           ...
           try{
               ...
               pst = con.prepareStatement("SELECT * FROM tbl_login WHERE username=? and password=?");
               ...
               if(rs.next()){
                  ...
                  //so sánh nếu s1 == với qlsv của chuỗi role thì đăng nhập tới main của QLSV
